...
namespace BookingManager.Application.Behaviours
{
        ...
        where TRequest : notnull
    {
        ...
        private readonly BookingManagerContext _dbContext;

        public TransactionBehaviour(BookingManagerContext dbContext,
                                    ILogger<TransactionBehaviour<TRequest, TResponse>> logger)
        {
            _dbContext = dbContext ?? throw new ArgumentException(nameof(BookingManagerContext));
